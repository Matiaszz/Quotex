...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionModel> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException ex){
        ExceptionModel error = new ExceptionModel(
                ...
                ex.getClass().getSimpleName(),
                "Some ID in your request is invalid, check if you have typed the UUID " +
                        "in the endpoint or in the payload correctly",
                ex.getMessage()
        );
    ...
    public ResponseEntity<ExceptionModel> handleHttpMessageNotReadable(HttpMessageNotReadableException ex) {
